...
ref = {"названия":[], "цены":[], "количества":[], "един":[]}
for item in products:
    ref["названия"].append(item[1]["название"])
    ref["цены"].append(item[1]["цена"])
    ref["количества"].append(item[1]["количество"])
    ref["един"].append(item[1]["един"])
